...
//   - URL string
//   - alias string
func (_e *URLSaver_Expecter) SaveURL(URL interface{}, alias interface{}) *URLSaver_SaveURL_Call {
	return &URLSaver_SaveURL_Call{Call: _e.mock.On("SaveURL", URL, alias)}
}

func (_c *URLSaver_SaveURL_Call) Run(run func(URL string, alias string)) *URLSaver_SaveURL_Call {
